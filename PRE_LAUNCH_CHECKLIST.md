...
> 当前正式基线：`main / b84b3cd / 缓存 20260712-07 / https://yomeru.japanese-hub.com`。上表 2026-07-10 的 PDF Beta 条目仅为历史决策，已由 2026-07-12 条目撤销。
...
- [x] **最近线上版本定向验收** - 用户已确认手机端定向修改正常；该证据不扩展为完整 iPhone 闭环 PASS
- [ ] **当前正式版本线上独立复核** - 正式基线 `b84b3cd / 20260712-07 / https://yomeru.japanese-hub.com`；本轮抓取受环境阻断，保持 PENDING/BLOCKED，不推测 PASS
...
### 🔴 高优先级（必须完成）
1. 完成剩余核心功能与异常场景测试
2. 完成数据恢复和真实 Safari / iPhone 验收；PDF 公开入口已撤下，不属于当前 MVP 验收范围
