...
const data = {
  basic: [
    ...
    item('朝ごはんを食べます。','朝ごはん','あさごはん','朝ごはん','あさごはん','名詞','','','known-chinese',''),
    item('映画を見ます。','映画','えいが','映画','えいが','名詞','','','known-chinese','N5'),
    item('週末は休みます。','週末','しゅうまつ','週末','しゅうまつ','名詞','','','known-chinese',''),
    ...
    item('日本語を学びます。','日本語','にほんご','日本語','にほんご','名詞','','','jmdict-fallback',''),
    item('毎朝七時に起きます。','毎朝','まいあさ','毎朝','まいあさ','名詞','','','known-chinese','N5'),
    item('七時に出発します。','七時','しちじ','七時','しちじ','名詞','','','known-chinese',''),
    ...
    item('日本へ来ました。','日本','にっぽん','日本','にっぽん','名詞','','','jmdict-fallback','N3'),
  ...
  verbs: [
    ...
    item('宿題をする。','する','する','する','する','動詞','サ変・スル','基本形','jmdict-fallback',''),
    item('毎日勉強します。','します','します','する','する','動詞','サ変・スル','連用形','jmdict-fallback',''),
    item('昨日掃除した。','した','した','する','する','動詞','サ変・スル','連用形','jmdict-fallback',''),
    item('先生は学生に練習させる。','させる','させる','する','する','動詞','サ変・スル','未然レル接続','jmdict-fallback',''),
    item('友達が来る。','来る','くる','来る','くる','動詞','カ変・来ル','基本形','jmdict-fallback',''),
    item('来週、日本へ来ます。','来ます','きます','来る','くる','動詞','カ変・来ル','連用形','jmdict-fallback',''),
    item('今日は来ない。','来ない','こない','来る','くる','動詞','カ変・来ル','未然形','jmdict-fallback',''),
    item('昨日は来なかった。','来なかった','こなかった','来る','くる','動詞','カ変・来ル','未然形','jmdict-fallback',''),
    ...
    item('写真を撮る。','撮る','とる','撮る','とる','動詞','五段・ラ行','基本形','jmdict-fallback','N5'),
    item('写真を撮った。','撮った','とった','撮る','とる','動詞','五段・ラ行','連用タ接続','jmdict-fallback','N5'),
    ...
    item('仕事が終わる。','終わる','おわる','終わる','おわる','動詞','五段・ラ行','基本形','jmdict-fallback',''),
    item('仕事が終わった。','終わった','おわった','終わる','おわる','動詞','五段・ラ行','連用タ接続','jmdict-fallback',''),
    item('本を買う。','買う','かう','買う','かう','動詞','五段・ワ行促音便','基本形','jmdict-fallback',''),
    item('本を買った。','買った','かった','買う','かう','動詞','五段・ワ行促音便','連用タ接続','jmdict-fallback',''),
    item('名前を呼ぶ。','呼ぶ','よぶ','呼ぶ','よぶ','動詞','五段・バ行','基本形','jmdict-fallback','N5'),
    item('名前を呼んだ。','呼んだ','よんだ','呼ぶ','よぶ','動詞','五段・バ行','連用タ接続','jmdict-fallback','N5')
  ],
  adjectives: [
    ...
    item('問題は難しい。','難しい','むずかしい','難しい','むずかしい','形容詞','形容詞・イ段','基本形','jmdict-fallback','N5'),
    item('試験は難しかった。','難しかった','むずかしかった','難しい','むずかしい','形容詞','形容詞・イ段','連用タ接続','jmdict-fallback','N5'),
    item('この問題は易しい。','易しい','やさしい','易しい','やさしい','形容詞','形容詞・イ段','基本形','jmdict-fallback',''),
    item('説明は簡単だ。','簡単だ','かんたんだ','簡単','かんたん','名詞','','','jmdict-fallback','N4'),
    item('操作は簡単です。','簡単です','かんたんです','簡単','かんたん','名詞','','','jmdict-fallback','N4'),
    item('町は便利だ。','便利だ','べんりだ','便利','べんり','名詞','','','jmdict-fallback','N5'),
    item('この道具は便利です。','便利です','べんりです','便利','べんり','名詞','','','jmdict-fallback','N5'),
    item('先生は親切だ。','親切だ','しんせつだ','親切','しんせつ','名詞','','','known-chinese','N4'),
    item('先生は親切です。','親切です','しんせつです','親切','しんせつ','名詞','','','known-chinese','N4'),
    item('説明が丁寧だ。','丁寧だ','ていねいだ','丁寧','ていねい','名詞','','','known-chinese','N4'),
    item('丁寧に話します。','丁寧に','ていねいに','丁寧','ていねい','名詞','','','known-chinese','N4'),
    item('元気な子です。','元気な','げんきな','元気','げんき','名詞','','','jmdict-fallback','N5'),
    item('今日は元気です。','元気です','げんきです','元気','げんき','名詞','','','jmdict-fallback','N5'),
  ...
  function_words: [
    ...
    item('食べている。','いる','いる','いる','いる','動詞','一段','基本形','function-word','', {allowReadingLookup:false}),
    item('行ってみる。','みる','みる','みる','みる','動詞','一段','基本形','function-word','', {allowReadingLookup:false}),
    item('読めば分かる。','ば','ば','ば','ば','助詞','','','function-word','', {allowReadingLookup:false}),
    item('雨でも行く。','でも','でも','でも','でも','助詞','','','function-word','', {allowReadingLookup:false}),
    item('しかし、雨だった。','しかし','しかし','しかし','しかし','接続詞','','','function-word','', {allowReadingLookup:false}),
    item('そして家に帰った。','そして','そして','そして','そして','接続詞','','','function-word','', {allowReadingLookup:false}),
    item('この本をください。','この','この','この','この','連体詞','','','function-word','', {allowReadingLookup:false}),
    item('その人は先生です。','その','その','その','その','連体詞','','','function-word','', {allowReadingLookup:false}),
    item('あの店は有名です。','あの','あの','あの','あの','連体詞','','','function-word','', {allowReadingLookup:false})
  ],
  ambiguity: [
    ...
    item('髪を切る。','髪','かみ','髪','かみ','名詞','','','jmdict-fallback','N4', {mustNotContain:['纸','神']}),
    ...
    item('生と死を考える。','生','せい','生','せい','名詞','','','context-dependent','', {mustNotContain:['なま']}),
    ...
    item('人気がある。','人気','にんき','人気','にんき','名詞','','','jmdict-fallback','', {mustNotContain:['ひとけ']}),
    item('人気のない道。','人気','ひとけ','人気','ひとけ','名詞','','','jmdict-fallback','', {mustNotContain:['にんき']}),
    item('市場を調査する。','市場','しじょう','市場','しじょう','名詞','','','known-chinese','', {mustNotContain:['いちば']}),
    item('朝の市場へ行く。','市場','いちば','市場','いちば','名詞','','','jmdict-fallback','', {mustNotContain:['しじょう']}),
    item('今日中に終える。','今日中','きょうじゅう','今日中','きょうじゅう','名詞','','','unknown','', {mustNotContain:['こんにちちゅう']}),
  ...
  compounds: [
    ...
    item('情報通信技術を活用する。','情報通信技術','じょうほうつうしんぎじゅつ','情報通信技術','じょうほうつうしんぎじゅつ','名詞','','','unknown','', {isCompound:true}),
    item('少子高齢化が進む。','少子高齢化','しょうしこうれいか','少子高齢化','しょうしこうれいか','名詞','','','unknown','', {isCompound:true}),
    item('地球温暖化を防ぐ。','地球温暖化','ちきゅうおんだんか','地球温暖化','ちきゅうおんだんか','名詞','','','jmdict-fallback','', {isCompound:true}),
    item('経済成長が続く。','経済成長','けいざいせいちょう','経済成長','けいざいせいちょう','名詞','','','unknown','', {isCompound:true}),
    item('労働市場が変化する。','労働市場','ろうどうしじょう','労働市場','ろうどうしじょう','名詞','','','unknown','', {isCompound:true}),
    item('公共交通機関を使う。','公共交通機関','こうきょうこうつうきかん','公共交通機関','こうきょうこうつうきかん','名詞','','','unknown','', {isCompound:true}),
    item('研究開発費を増やす。','研究開発費','けんきゅうかいはつひ','研究開発費','けんきゅうかいはつひ','名詞','','','unknown','', {isCompound:true}),
    item('医療保険制度を改革する。','医療保険制度','いりょうほけんせいど','医療保険制度','いりょうほけんせいど','名詞','','','unknown','', {isCompound:true}),
    item('自然災害に備える。','自然災害','しぜんさいがい','自然災害','しぜんさいがい','名詞','','','unknown','', {isCompound:true}),
    item('再生可能エネルギーを使う。','再生可能エネルギー','さいせいかのうえねるぎー','再生可能エネルギー','さいせいかのうえねるぎー','名詞','','','unknown','', {isCompound:true}),
    ...
    item('外国人観光客が増えた。','外国人観光客','がいこくじんかんこうきゃく','外国人観光客','がいこくじんかんこうきゃく','名詞','','','unknown','', {isCompound:true}),
  ...
  news: [
    ...
    item('大学と企業が共同研究を始めた。','共同研究','きょうどうけんきゅう','共同研究','きょうどうけんきゅう','名詞','','','unknown','', {isCompound:true}),
    ...
    item('物価の上昇率が鈍化した。','上昇率','じょうしょうりつ','上昇率','じょうしょうりつ','名詞','','','unknown','', {isCompound:true}),
    item('雇用情勢は緩やかに改善した。','雇用情勢','こようじょうせい','雇用情勢','こようじょうせい','名詞','','','unknown','', {isCompound:true}),
    item('中央銀行は金利を据え置いた。','中央銀行','ちゅうおうぎんこう','中央銀行','ちゅうおうぎんこう','名詞','','','unknown','', {isCompound:true}),
    item('輸出額は前年を上回った。','輸出額','ゆしゅつがく','輸出額','ゆしゅつがく','名詞','','','unknown','', {isCompound:true}),
    ...
    item('自治体は避難所を開設した。','避難所','ひなんじょ','避難所','ひなんじょ','名詞','','','unknown','', {isCompound:true}),
    ...
    item('新幹線は通常通り運行している。','運行','うんこう','運行','うんこう','名詞','','','jmdict-fallback',''),
    item('医療機関の負担を軽減する。','医療機関','いりょうきかん','医療機関','いりょうきかん','名詞','','','unknown','', {isCompound:true}),
    item('研究チームが成果を公表した。','研究チーム','けんきゅうちーむ','研究チーム','けんきゅうちーむ','名詞','','','unknown','', {isCompound:true}),
    item('生成AIの利用指針をまとめた。','生成AI','せいせいえーあい','生成AI','せいせいえーあい','名詞','','','numeric-or-latin','', {isCompound:true}),
    item('個人情報の保護を強化する。','個人情報','こじんじょうほう','個人情報','こじんじょうほう','名詞','','','unknown','', {isCompound:true}),
    item('サイバー攻撃への対策を急ぐ。','サイバー攻撃','さいばーこうげき','サイバー攻撃','さいばーこうげき','名詞','','','unknown','', {isCompound:true}),
    item('再生可能エネルギーの比率を高める。','比率','ひりつ','比率','ひりつ','名詞','','','jmdict-fallback','N1'),
    item('温室効果ガスの排出量を削減する。','排出量','はいしゅつりょう','排出量','はいしゅつりょう','名詞','','','unknown','', {isCompound:true}),
    item('国会では法案の審議が続いた。','審議','しんぎ','審議','しんぎ','名詞','','','jmdict-fallback','N1'),
    item('選挙の投票率は前回を下回った。','投票率','とうひょうりつ','投票率','とうひょうりつ','名詞','','','unknown','', {isCompound:true}),
    item('海外市場で販売を開始する。','海外市場','かいがいしじょう','海外市場','かいがいしじょう','名詞','','','unknown','', {isCompound:true}),
